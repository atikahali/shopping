...
<center>
  ...
  <tr>
    ...
    <td width="400"><div align="center"><h1>EDIT</h1></div></td></p>
    <td width="77">&nbsp;</td>
...
<tr><td>Admin ID:</td>
<td><input type="text" name="adminId" value="<?php echo $adminId?>" </td></tr></br>
<tr><td>Username:</td>
<td><input type="text" name="username" value="<?php echo $username?>" </td></tr></br>
<tr><td>Name:</td>
<td><input type="text" name="name" value="<?php echo $name?>"></td></tr></br>
<tr><td>Phone Number</td>
<td><input type="text" name="phone" value="<?php echo $phone?>"></td></tr></br>
<tr><td>Email:</td>
<td><input type="text" name="email" value="<?php echo $email?>"></td></tr></br>
</br>
<tr><td colspan="2"><input type="hidden" name="username" value="<?php echo $username?>">
<input type="submit" name="AddAdmin" value=" OK "></br>
</form></td></tr>
</table>
<?php
if (isset($_POST['AddAdmin'])){
	...
	$conn = mysqli_connect("127.0.0.1", "root", "", "shoppingdb") or die (mysql_error ());
